<x-app-layout>
    <div class="py-12 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-8">Latest News</h1>
                    ...
                    @foreach($posts as $post)
                        <article class="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-200 flex flex-col md:flex-row">
                            ...
                            <div class="p-6 md:w-2/3 flex flex-col justify-between">
                                ...
                                <div class="mt-4">
                                    <a href="{{ route('blog.show', $post->slug) }}" class="text-primary-600 font-semibold hover:underline">Read More</a>
                                </div>
                            </div>
                        </article>
                    @endforeach
