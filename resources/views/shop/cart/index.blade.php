<x-app-layout>
 ...
 @csrf
 <input type="text" name="coupon_code" value="{{ $cart->coupon->code ?? '' }}" placeholder="{{ __('Coupon Code') }}" class="flex-1 rounded-md border-gray-300 shadow-md focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
