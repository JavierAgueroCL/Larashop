                    ...
                    <div class="ml-4 flex-1 flex flex-col">
                        <div>
                            <div class="flex justify-between text-base font-medium text-gray-900">
                                ...
                                <p class="ml-4">{{ number_format($item->price_snapshot, 2) }} €</p>
                            </div>
                            @if($item->combination)
...
@if($cart->items->isNotEmpty())
    <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
        <div class="flex justify-between text-base font-medium text-gray-900">
            <p>{{ __('Subtotal') }}</p>
            <p>{{ number_format($totals['subtotal'], 2) }} €</p>
        </div>
        ...
        <div class="mt-6 flex justify-center text-sm text-center text-gray-500">
            <p>
                or <a href="{{ route('cart.index') }}" class="text-indigo-600 font-medium hover:text-indigo-500">
                    {{ __('View Cart') }}<span aria-hidden="true"> &rarr;</span>
                </a>
            </p>
        </div>
    </div>
