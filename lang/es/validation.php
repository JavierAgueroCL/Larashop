...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'La :attribute dada ha aparecido en una filtración de datos. Por favor elige una :attribute distinta.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'address_line_2' => 'dirección (continuación)',
        'city' => 'ciudad',
        ...
        'billing_address.rut' => 'RUT',
        'billing_address.company' => 'razón social',
        'billing_address.business_activity' => 'giro',
        'billing_address.address_line_1' => 'dirección',
        'billing_address.region_id' => 'región',
        'billing_address.comuna_id' => 'comuna',
        'billing_address.phone' => 'teléfono',
        'shipping_address.first_name' => 'nombre',
        'shipping_address.last_name' => 'apellido',
        'shipping_address.address_line_1' => 'dirección',
        'shipping_address.region_id' => 'región',
        'shipping_address.comuna_id' => 'comuna',
        'shipping_address.phone' => 'teléfono',
    ],
